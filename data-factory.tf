...
# creates Linked Service for Azure SQL Database
...
# creates Linked Service for Azure Data Lake Storage Gen2
...
# creates a Dataset for SQL Server
...
# creates a Pipeline to Copy Data from SQL to ADLS
